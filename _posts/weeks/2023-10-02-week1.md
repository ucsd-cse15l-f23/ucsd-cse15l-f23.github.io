...
current: false
todos:
    - due-date: "1:00 pm (just before class) Wednesday October 4, 2023"
...
“Workspaces” area (FILL SCREENSHOT), then make a new Workspace. You can pick the
name, but something like “Lab1” is a good idea.
2. Then, let's access the code from class. Open a terminal (FILL screenshot),
and run the following command (TODO update to f23):
