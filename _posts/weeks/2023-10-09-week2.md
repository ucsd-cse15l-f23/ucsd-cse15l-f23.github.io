...
Once you have the username (which should look like `cs15lfa23XXX` with the `XXX` different for each student), you can reset just your course-specific password (you don't need to reset your overall account). Screenshots of what that looks like are here:
