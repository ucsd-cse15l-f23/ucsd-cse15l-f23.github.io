...
_Mondays at 9 am_ before the first lecture session (except week 1, which will be due _Wednesday before 9am_). The purpose of this quiz is to make sure everyone has checked in on the concepts we will be using in lab on Monday, Tuesday and
